...
const computeBlueprintScore = (blueprint, infLimit) => {
  ...
  console.log(
    ...
    blueprint.blueprintId,
    " is ",
    bestGeodeNumber * blueprint.blueprintId
  );

  return {
    hasFinished: true,
    qualityLevel: bestGeodeNumber * blueprint.blueprintId,
  };
};

const blueprints = await parseInput(false);
